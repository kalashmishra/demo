...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      ...
      <div className="cred_page_wrapper">
        <div className="container">
          <div className="cred_page_content">
            ...
            <p>
              ...
              Zappian Fintech Private Limited including its subsidiaries, group
              companies and affiliates (“Credmudra”).
            </p>
            ...
            <p>
              ...
              collects data from EU residents or processes such data. We are not
              involved in either collecting data from EU residents or in
              ...
              <strong>
                ...
                the GDPR. Therefore, while we endeavour to implement
                world-className privacy norms, we do not actively seek
                compliance with the GDPR. If you are an EU citizen, please be
                advised that by using this Website or transacting with us, you
                waive all and any entitlement that may otherwise be available to
                you under the GDPR.
              </strong>{" "}
            ...
            <p>
              The California Consumer Privacy Act (CCPA) is a regulation that is
              intended to enhance privacy rights and consumer protection for
              residents of California, United States. The CCPA provides certain
              rights to California residents with respect to their personal
              data. The CCPA applies to a business that collects consumers’
              personal data, which does business in California, and satisfies
              certain financial thresholds. We are not involved in either
              collecting data from California residents or in doing business in
              California. We do not offer our products or services within
              California.{" "}
              <strong>
                As such, we are not required to conform to the stipulations of
                ...
                please be advised that by using this Website or transacting with
                us, you waive all and any entitlement that may otherwise be
                available to you under the CCPA.
              </strong>{" "}
            ...
            <ul>
              <li>
                “Credmudra Platform” means the set of proprietary APIs, SDKs,
                tools, plugins, code, technology, content, and services that are
                made available over the Website and includes the microsites
                created therefrom.
              </li>
              ...
              <li>
                “Services” means a service that we provide for a fee or gratis.
              ...
              <li>
                ...
                . You are using our Services when you are visiting our website.
              </li>

              <li>
                “you” refers to you, as a visitor to the Website and Credmudra
                Platform, as a user or subscriber of the Services, or as a
                person whose information is made available to us.
              </li>
            </ul>
            ...
            <p>
              We understand the importance of data and its privacy. This Privacy
              Policy explains the type of information we collect or we receive,
              how we handle your information and comply with the requirements of
              applicable privacy laws. All your transactions and use of our
              Services over the Credmudra Platform will be covered by the terms
              of this Privacy Policy.
            </p>

            <p>
              This Privacy Policy is applicable to any person who visits the
              Credmudra Platform, or inquiries about our Services, or avails our
              Services, or whose information is otherwise made available to us
              in the context of the Services or otherwise. You may note that
              ...
              Policy. We recommended that you review the privacy statements and
              policies of any such third parties with whom they interact. We do
              not make any representations concerning the privacy practices or
              policies of such third parties or terms of use of such websites,
              nor do we guarantee the accuracy, integrity, or quality of the
              information and content available on such websites. Their
              inclusion or exclusion on the Credmudra Platform does not imply
              our endorsement.
            </p>
            ...
            <p>
              ...
              information only in the manner set out in this Privacy Policy. We
              are committed to safeguarding the privacy of our website visitors,
              clients, prospects, and other third-parties. This Privacy Policy
            ...
            <ul>
              <li>
                We promise to protect your privacy and treat the information you
                give us as confidential.
              </li>
              ...
              <li>
                Your decision to provide or not to provide any information will
            ...
            <p>
              ...
              information from other sources. Such information may, inter alia,
              include the following:
            </p>

            <ul>
              <li>
                Your <strong>personal identifiable information</strong>{" "}
                including your demographic details (such as your name, gender,
                marital status, age), contact details (such as your email
                address, postal addresses, telephone number), identify proofs
                such as PAN, Aadhaar card number, KYC related documentation,
                educational qualifications, employment details, information
                related to your spouse, children and/or parents or information
                related to family, your health-related information, your
                insurance related data and your investments related information;
              </li>

              <li>
                Your <strong>financial information</strong> including banking
                details (such as your bank account no., bank, branch, IFSC),
                your fiscal details (such as your income and expenses), credit
                scores, credit bureau data, bank statements, income tax returns,
                other statutory returns, salary details, mode of salary,
                monetary requirements, borrowing requirements, loan requirement
                reasons;
              </li>

              <li>
                Your <strong>technical Information</strong> collected by our
                technology (such as your browser type, operating system, server
                details, Internet Protocol (IP) address);
              </li>

              <li>
                <strong>Information</strong>{" "}
                <strong>voluntarily provided by you</strong> while using our
                Services (such as engaging with third-parties including banks,
                NBFCs and other financial institutions, our marketing and
                channel partners associated with the Credmudra Platform);
              </li>

              <li>
                <strong>Information generated while you transact</strong> on
                Credmudra Platform (such as enquiring or availing a loan from a
                financial institution or using any loan products or financial
                products) including information requested by financial
                instructions and third-party marketing partners and service
                providers associated with us for processing your loan
                application or providing you with Services;
              </li>

              <li>
                <strong>Security-related information</strong> used by you while
                accessing the Credmudra Platform (such as usernames, passwords,
                email addresses)
              </li>
              ...
              <li>
                ...
                <strong>you make disclosures</strong> through the Credmudra
                Platform or while using our Services (such as a nominee). In
                such case, you must confirm and represent that each of the other
                investor(s) for whom an enquiry/ transaction has been made, has
                agreed to have the information shared by you, disclosed to us
                and further be shared by us with our business partners.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                system, server details, referral source, length of your visit,
                page views and website navigation paths, as well as information
                about the timing, frequency and pattern of use of our Service.
                The source of the usage data is our analytics tracking system.
                In addition, we may use third-party analytics tracking services
                such as Google Analytics and Facebook Pixel. This usage data may
                ...
                this processing is your consent. In some cases, the legal basis
                for this processing is our legitimate interests, namely
                monitoring and improving our Website, Credmudra Platform and our
                Services.
              </li>

              <li>
                We may process your data that is provided to us during the
                course of you taking assessments on our Website and Credmudra
                Platform (“response data”). The response data may include your
                personally identifiable information, financial information and
                your responses to the questions that we may ask you. The source
                of the response data is you. The response data may be processed
                for the purposes of providing our services, ensuring the
                integrity of our operations and processes, maintaining back-ups
                of our databases, and for communicating with you. The legal
              ...
              <li>
                ...
                include your personal information including your name, address,
                telephone number, email address, profile pictures, gender, date
                of birth, relationship status, educational details and bank
                account details. The profile data may be processed for the
                purposes of enabling and monitoring your use of our Website and
                Services, for providing Services to you, and for communicating
                with you. The legal basis for this processing is your consent.
                In some cases, the legal basis for this processing is our
                legitimate interests, namely the proper administration and
                operation of our Website, Credmudra Platform and our Services.
              </li>

              <li>
                We may process your personal data, financial data and
                information generated in the course of the use of our Services
                (“service data”). The source of the service data is you. The
                service data may be processed for the purposes of providing our
                Services, ensuring the security of our Website, Credmudra
                Platform and our Services, maintaining back-ups of our
                databases, and for communicating with you. The legal basis for
                this processing is your consent. In some cases, the legal basis
                for this processing is our legitimate interests, namely the
                proper administration of our Website and business. In some
                cases, the legal basis for this processing is the performance of
              ...
              <li>
                ...
                Website or Credmudra Platform or through our Services
                (“publication data”). The publication data may be processed for
                the purposes of enabling such publication and administering our
                Website and Services. The legal basis for this processing is
                your consent. In some cases, the legal basis for this processing
                is our legitimate interests, namely the proper administration of
                our Website and business. In some cases, the legal basis for
                this processing is the performance of a contract between you and
              ...
              <li>
                ...
                to us regarding our Services (“enquiry data”). The enquiry data
                may be processed for the purposes of offering, marketing and
                selling relevant goods and/or services to you and for and for
              ...
              <li>
                ...
                your name and your contact details. The source of the customer
                ...
                you, communicating with you, keeping records of those
                communications and promoting our products and services to
                customers. The legal basis for this processing is your consent.
                In some cases, the legal basis for this processing is our
              ...
              <li>
                ...
                applying for any loans, making a borrowing from the financial
                institutions, availing loan products or financial products
                offered by the lending institutions that you enter into with
                through our Website or Credmudra Platform (“transaction data”).
                The transaction data may include your personal, financial,
                technical information or any data that you voluntarily provide
                or we receive while you transact using our Website or Credmudra
                Platform. The transaction data may be processed for the purpose
                of supplying the Services, keeping proper records of those
            ...
            <p>
              ...
              personal data set out in this Section, we may process any of your
              personal data identified in this Privacy Policy where necessary
              for:
            </p>

            <ul>
              <li>
                the establishment, exercise or defence of legal claims, whether
            ...
            <ul>
              ...
              <li>
                To enable communications between financial institutions such as
                banks and NBFCs, third-party service providers, marketing
              ...
              <li>
                ...
                consent, and identity verification services to facilitate banks
                and other financial institutions to evaluate your loan request
                in the context of your complete financial situation
              </li>
              ...
              <li>
                To publish fact-based views and opinions regarding, inter alia,
                the Services offered on the Credmudra Platform, based on the
                information available on the Credmudra Platform;
              </li>

              <li>
                To improve the quality of your experience when you interact with
                the Credmudra Platform and use our Services;
              </li>
              ...
              <li>
                To prevent and detect fraud or abuse of our Services as well as
                to prevent, detect and investigate any potential unlawful or
            ...
            <p>
              By accepting this Privacy Policy, you hereby consent to the use of
              your personal data by Credmudra for the purposes listed below. We
              may share your data with legal or statutory or regulatory agencies
              or authorities; our employees, officers, advisors and agents; our
              marketing partners, our channel partners, transactional
              counterparties such as including banks, NBFCs, financial
              institutions or service providers acting on our behalf (as the
              case may be), etc. solely for the purposes listed in this Privacy
              Policy.
            </p>

            <p>
              We may share the information given by you with third parties where
              we feel that such third parties may{" "}
              <strong>improve the quality of services </strong>imparted by us to
              you. Additionally, we also employ third-party service providers
              and individuals{" "}
              <strong>
            ...
            <p>
              ...
              <strong>complete billing operations</strong>. We may require you
              to make payments for the Services availed by using your credit
              card, wire transfer, debit card or cheque/cash. Verification of
              credit information, however, is accomplished solely by you through
              the authentication process. Your credit card/debit card details
              are transacted upon secure sites of approved payment gateways
              which are digitally under encryption, thereby providing the
              highest possible degree of care as per current technology. We
              provide you an option not to save your payment details. You are
              advised, however, that internet technology is not fully safe and
              you should exercise discretion while using the same.
            </p>
            ...
            <p>
              ...
              <strong>compliance with a legal obligation</strong> to which we
            ...
            <p>
              ...
              basis with any third party. We shall take all reasonable steps to
              ensure that the confidentiality of your information is maintained
              by imposing strict confidentiality standards on all the third
              parties with whom we part this information. In all circumstances
              we shall ensure that your personal information is protected by
              strict confidentiality terms. We shall not allow any third parties
              to retain your personal information longer than what is warranted
              by the nature of services rendered.
            </p>

            <p>
              By agreeing to avail the service offered by Credmudra, you agreed
              to the collection, use and sharing of your personal data or
              Information by Credmudra as per the terms of this Privacy Policy.{" "}
              <strong>
                You always have the right to refuse or withdraw your consent to
                share/dissemination of your personal data by contacting us as
                per the details provided in this Privacy Policy.{" "}
              </strong>
              However, in such an event, you may no longer be eligible to avail
              our services.
            </p>
            ...
            <p>
              ...
              those purposes. Subject to exceptions based on your continuing use
              of the Credmudra Platform, we intend retain your personal data as
              follows:
            </p>
            ...
            <ul>
              ...
              <li>
                Response data will be retained for a minimum period of one month
                following the submission of your response, and for a maximum
                period of ten years following the submission of your last
                response.
              </li>
              ...
              <li>
                Service data will be retained for a minimum period of one month
                following the fulfilment of the Service, and for a maximum
                period of ten years following the last date on which any
                obligation in respect of such Service concludes.
              </li>
              ...
              <li>
                Customer relationship data will be retained for a minimum period
                of one month following the conclusion of the said relationship,
                and for a maximum period of ten years following the conclusion
              ...
              <li>
                ...
                period of ten years following the date of the last transaction.
              </li>
              ...
              <li>
                Correspondence data will be retained for a minimum period of one
                day following the date of the communication, and for a maximum
                period of twenty years following the date of the communication.
              </li>
            </ul>
            ...
            <p>
              ...
              required in order to protect your or any third-party interest. You
              understand that financial institutions who has evaluated your data
              for credit or any entity who has provided their service through us
              may store all the data collected as per their statutory and
            ...
            <p>
              ...
              peruse the relevant laws for a complete understanding your rights.
            ...
            <ul>
              <li>
                ...
                concerned and the recipients of the personal data. Subject to
                the condition that the rights and freedoms of others are not
                affected, we will supply to you a copy of your personal data.
              ...
              <li>
                ...
                the erasure of your personal data without undue delay. However,
              ...
              <li>
                Right to restrict processing: In some circumstances you have the
                right to restrict the processing of your personal data. Those
                circumstances are: you contest the accuracy of the personal
                data; processing is unlawful but you do not desire erasure; we
                ...
                store your personal data. However, we will only otherwise
                process it: with your consent; for the establishment, exercise
                or defence of legal claims; for the protection of the rights of
              ...
              <li>
                ...
                or the processing is for the establishment, exercise or defence
                of legal claims.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                for our processing of your personal data is: (a) consent; or (b)
                ...
                apply where it would adversely affect the legal or contractual
                rights of third-parties or where the law requires otherwise.
              </li>
            </ul>
            ...
            <p>
              ...
              wish to exercise and identify your information in respect of which
              you wish to exercise such right. Please note that as a security
              measure, we may require you to verify your identity before
              accepting any request concerning your personal data.
            </p>
            ...
            <p>
              ...
              request to the website. Cookies do not typically contain any
            ...
            <p>
              ...
              and it is advised that you utilize a Service to protect access to
              such device.
            </p>

            <p>
              Our information security policy may contain managerial, technical,
              operational and physical security control measures that may be
              commensurate with the information being protected herein. We are
              committed to continuously develop and implement administrative,
              technical and physical security measures to protect such
              information from unauthorized access or against loss, misuse or
              alteration. While we <strong>endeavour</strong> to take all
              reasonable and appropriate steps to keep secure the information
              collected and prevent unauthorized access, you acknowledge that
              the internet is not entirely secure and that we cannot and
              therefore do not provide any absolute assurance regarding the
              security of the information collected. We also cannot warrant that
              such your information may not be misused in the event our
              safeguards and protocols are breached by a malicious third-party.
              Further, we are not liable to, nor can we fully control the
              actions of other users with whom you may choose to share your
              information.
            </p>
            ...
            <ul>
              ...
              <li>
                Notify the appropriate regulatory/Statutory Bodies and affected
                parties;
              </li>

              <li>
                Take the steps to improve the system security on a going forward
                basis.
              </li>
            </ul>
            ...
            <p>
              ...
              “unsubscribe” link or follow the instructions in each message. You
              may share your feedback and comments with us, including that
              relating to an issue or incidence. To report an incidence
              regarding your data, you may contact us using our contact details
              and inform us about such incidence.
            </p>
            ...
            <p>
              ...
              access to your computer or device. We shall not be responsible for
              any breach of security or for any actions of any third parties
              that receives your personal data or events that are beyond our
              reasonable control including, acts of government, computer
              hacking, unauthorised access to computer data and storage device,
              computer crashes, breach of security and encryption, poor quality
              of internet service or telephone service etc. Our liability is
              strictly limited in all cases to the extent set out in the Terms
              of Use document; please read the Terms of Use document before
            ...
            <p>
              We may generate derived data and anonymous statistical information
              based on the data available on the Credmudra Platform. Such
              derived data and anonymous statistical information shall not
              identify you at a personal level, and shall be exclusively our
              property. We may use such data or information for any legitimate
              purpose as we may determine, without any compensation to you.
            </p>
            ...
            <ul>
              <li>
                ...
                U74999MP2022PTC062894, and our registered office address is: 3rd
                Floor, A 305, Rustomjee Central Park, Andheri-Kurla Road, Opp.
              ...
              <li>
                ...
                provided above; or (b) by email: on [email];
              </li>
            ...
            <p>
              We appreciate you taking the time to read this Privacy Policy. We
              know that you are placing your trust in us when you choose to
